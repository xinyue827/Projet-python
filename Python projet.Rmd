...
Notre objectif est de collecter les emails des ressources humaines (RH) en fonction des informations obtenues, d'automatiser la rédaction d'email en fonction de la description du poste, de l'email de recrutement et de l'envoi de notre CV pour effectuer la postulation.
